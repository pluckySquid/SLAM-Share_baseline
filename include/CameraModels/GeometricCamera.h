...
namespace ORB_SLAM3 {
    ...
    void serialize(Archive &ar, const unsigned int version)
        {
	    //https://stackoverflow.com/questions/35753953/common-confusions-with-serializing-polymorphic-types
	    std::cout << "GeometricCamera OK1" << std::endl;
            ar & mnId;
	    //std::cout << "GeometricCamera OK2" << std::endl;
            ar & mnType;
	    //std::cout << "GeometricCamera OK3" << std::endl;
            ar & mvParameters;
	    std::cout << "GeometricCamera OK4" << std::endl;
        }

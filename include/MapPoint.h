...
public:
    ...
    bool EraseObservation_it(KeyFrame* pKF, std::map<KeyFrame*,std::tuple<int,int> >::const_iterator &it);
...
public:
    ...
    static long unsigned int nNextId_backup;
...
protected:    
     ...
     // Reference KeyFrame
     KeyFrame* mpRefKF;
     long unsigned int mBackupRefKFId = -1;

...
int main(int argc, char **argv)
{
    ...
    //ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::MONOCULAR, true,  0, "", argv[4], argv[6]);
    //ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::MONOCULAR, true, 0, "", "./04262021_2maps.osa", "./04262021_2maps.osa");
    //ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::MONOCULAR, true, 0, "", "", "./MH02_mono_0707.osa" );
    //Hard coded .osa file as input, no need input


    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::MONOCULAR, true, 0, "", "./smallmap8.osa", "./MH04-6.osa" );
    //SLAM.saveSmallAtlas(6);
...
SLAM.Shutdown();
    ...
    // }
    // // ********** Yunshu Note: read images for the last 4 arguments*******//

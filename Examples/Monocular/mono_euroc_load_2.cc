...
int main(int argc, char **argv)
{
    ...
    //int smallmap_frames[13] = {192, 342, 494, 665, 872, 1002, 1209, 1360, 1483, 1697, 1750, 1944, 2054};
    //int smallmap_frames[13] = {300, 503, 598, 895, 1108, 1259, 1455, 1548, 1600, 1870, 2026, 2233, 2268};
    //int smallmap_frames[13] = {300, 503, 598, 955, 1298, 1610, 2108, 2300, 2300, 23200, 2300, 2300, 2300};
    int smallmap_frames[13] = {176,326, 478, 649, 855, 985, 1193, 1344, 1476, 1681, 1734, 1927, 2038};
    //smallmap_frames = [192, 342, 494, 665, 872, 1002, 1209, 1360, 1483, 1697, 1750, 1944, 2054]
    ///int smallmap_frames[13] = {239, 415, 538, 772, 981, 1123, 1323, 1446, 1534, 1774, 1879, 2095,	2152};


    int smallmap_counter = 0;
    ...
    int tot_images = 0;
    //change     for (seq = 0; seq<num_seq -1 ; seq++)
   ...
   // for (seq = 0; seq<num_seq ; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            if(seq == 2  && ni > smallmap_frames[smallmap_counter]){
                //const string kf_file =  "kf_smallmap" +to_string(ni) + ".txt";
               // SLAM.SaveKeyFrameTrajectoryEuRoC(kf_file);
                  SLAM.addSmallAtlas(6);
                  smallmap_counter++;
            }

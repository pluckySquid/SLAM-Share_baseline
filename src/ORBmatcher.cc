...
{
    //cout << "ORBmatcher::SearchByBoW 00" << endl;
    ...
    //cout << "ORBmatcher::SearchByBoW 01" << endl;
    ...
    //cout << "ORBmatcher::SearchByBoW 10" << endl;
    if(mbCheckOrientation)
    {
        int ind1=-1;
        int ind2=-1;
    ...
    //cout << "ORBmatcher::SearchByBoW end" << endl;
    return nmatches;
}
...
int ORBmatcher::SearchByBoW(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches12)
{
    ...
    while(f1it != f1end && f2it != f2end)
    {
        if(f1it->first == f2it->first)
        {
            ...
            {
		//cout << "ORBmatcher::SearchByBoW 02" << endl;
                const size_t idx1 = f1it->second[i1];
                if(pKF1 -> NLeft != -1 && idx1 >= pKF1 -> mvKeysUn.size()){
                    continue;
                }
		//cout << "ORBmatcher::SearchByBoW 02.1, vpMapPoints1 size: " << vpMapPoints1.size() << ".idx1: " << idx1 << endl;
                MapPoint* pMP1 = vpMapPoints1[idx1];
		//cout << "ORBmatcher::SearchByBoW 02.1.1" << endl;
                if(!pMP1)
                    continue;
                if(pMP1->isBad())
                    continue;
		//cout << "ORBmatcher::SearchByBoW 02.2" << endl;
                const cv::Mat &d1 = Descriptors1.row(idx1);

                int bestDist1=256;
                int bestIdx2 =-1 ;
                int bestDist2=256;
		//cout << "ORBmatcher::SearchByBoW 03" << endl;
		...
		//cout << "ORBmatcher::SearchByBoW 04" << endl;
                if(bestDist1<TH_LOW)
                {
                    if(static_cast<float>(bestDist1)<mfNNratio*static_cast<float>(bestDist2))
                    {
			//cout << "ORBmatcher::SearchByBoW 04.1" << endl;
                        vpMatches12[idx1]=vpMapPoints2[bestIdx2];
                        vbMatched2[bestIdx2]=true;
			//cout << "ORBmatcher::SearchByBoW 04.2" << endl;
                        if(mbCheckOrientation)
                        {
		...
		//cout << "ORBmatcher::SearchByBoW 05" << endl;
            }

...
struct timeval Tracking::start_create_map = (struct timeval){0};
...
void Tracking::Track()
{
    ...
    if(mState!=NO_IMAGES_YET)
    {
        ...
        //}
        //else
        if(mCurrentFrame.mTimeStamp>mLastFrame.mTimeStamp+50.0)
        {
            cout << "id last: " << mLastFrame.mnId << "    id curr: " << mCurrentFrame.mnId << endl;
            cout << "mLastFrame.mTimeStamp: " << mLastFrame.mTimeStamp << "    mCurrentFrame.mTimeStamp: " << mCurrentFrame.mTimeStamp << endl;
...
{
    gettimeofday(&start_create_map, NULL);

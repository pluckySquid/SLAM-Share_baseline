...
void System::setLoadMap_Yunshu(bool isRead){
 //isRead = isread;

 //should be discard later
  ...
  //  mpAtlas->CreateNewMap();
    ...
    for(int i = 0; i < vm.size(); i++){
        ...
        for(auto k : m->GetAllKeyFrames()){
            ...
            cout << "------k: " << k << endl;
            cout << "------vm.size() size: " << vm.size() << endl;
            cout << "------press enter to continue------vkf size: " << m->GetAllKeyFrames().size() << endl;
    ...
    //usleep(10000);
    cout << "------press enter to continue------vkf size: " << endl;

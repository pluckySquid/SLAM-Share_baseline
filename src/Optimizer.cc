...
{   
    ...
    // Setup optimizer
    //cout << "Optimizer::OptimizeEssentialGraph 7para start" << endl;
    g2o::SparseOptimizer optimizer;
    optimizer.setVerbose(false);
    ...
    //cout << "Optimizer::OptimizeEssentialGraph 7para 01" << endl;
    // Set KeyFrame vertices
    ...
    //cout << "Optimizer::OptimizeEssentialGraph 7para 02" << endl;
    // Set Loop edges
    int count_loop = 0;
    ...
    //cout << "Optimizer::OptimizeEssentialGraph 7para 05" << endl;
    ...
    //cout << "Optimizer::OptimizeEssentialGraph 7para 06" << endl;
    ...
    //cout << "Optimizer::OptimizeEssentialGraph 7para 07" << endl;
    // Correct points. Transform to "non-optimized" reference keyframe pose and transform back with optimized pose
    for(size_t i=0, iend=vpMPs.size(); i<iend; i++)
    {
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.1" << endl;
        MapPoint* pMP = vpMPs[i];
	
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.2" << endl;
        if(pMP->isBad())
            continue;
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.3" << endl;
        int nIDr;
        if(pMP->mnCorrectedByKF==pCurKF->mnId)
        {
	    //cout << "Optimizer::OptimizeEssentialGraph 7para 07.3.1" << endl;
            nIDr = pMP->mnCorrectedReference;
	    //cout << "Optimizer::OptimizeEssentialGraph 7para 07.3.2" << endl;
        }
        else
        {
	    //cout << "Optimizer::OptimizeEssentialGraph 7para 07.3.3" << endl;
            KeyFrame* pRefKF = pMP->GetReferenceKeyFrame();
	    //cout << "Optimizer::OptimizeEssentialGraph 7para 07.3.4" << endl;
	    if(pRefKF == NULL) continue;
            nIDr = pRefKF->mnId;
	    //cout << "Optimizer::OptimizeEssentialGraph 7para 07.3.5" << endl;
        }

	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.4" << endl;
	...
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.5" << endl;
        cv::Mat cvCorrectedP3Dw = Converter::toCvMat(eigCorrectedP3Dw);
        pMP->SetWorldPos(cvCorrectedP3Dw);
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.6" << endl;
        pMP->UpdateNormalAndDepth();
	//cout << "Optimizer::OptimizeEssentialGraph 7para 07.7" << endl;
    }

    // TODO Check this changeindex
    pMap->IncreaseChangeIndex();
    //cout << "Optimizer::OptimizeEssentialGraph 7para end" << endl;
}
...
{
    cout << "LocalBundleAdjustment 00" << endl;
    ...
    cout << "LocalBundleAdjustment 01" << endl;
    linearSolver = new g2o::LinearSolverEigen<g2o::BlockSolver_6_3::PoseMatrixType>();
    cout << "LocalBundleAdjustment 02" << endl;
    g2o::BlockSolver_6_3 * solver_ptr = new g2o::BlockSolver_6_3(linearSolver);
    ...
    cout << "LocalBundleAdjustment 03" << endl;
    //set<MapPoint*> sNumObsMP;
    ...
    cout << "LocalBundleAdjustment 04" << endl;
    ...
    cout << "LocalBundleAdjustment 05" << endl;
    ...
    cout << "LocalBundleAdjustment 06" << endl;
    for(unsigned int i=0; i < vpMPs.size(); ++i)
    {
        MapPoint* pMPi = vpMPs[i];
        if(pMPi->isBad())
    ...
    cout << "LocalBundleAdjustment 07" << endl;
    ...
    if(pbStopFlag)
        if(*pbStopFlag)
            bDoMore = false;
    cout << "LocalBundleAdjustment 08" << endl;
    ...
    cout << "LocalBundleAdjustment 09" << endl;
    // Check inlier observations
    int badMonoMP = 0, badStereoMP = 0;
    for(size_t i=0, iend=vpEdgesMono.size(); i<iend;i++)
    {
    ...
    cout << "LocalBundleAdjustment 10" << endl;
    for(size_t i=0, iend=vpEdgesStereo.size(); i<iend;i++)
    {
        g2o::EdgeStereoSE3ProjectXYZ* e = vpEdgesStereo[i];
        MapPoint* pMP = vpMapPointEdgeStereo[i];
    ...
    cout << "LocalBundleAdjustment 11" << endl;
    if(!vToErase.empty())
    {
    ...
    cout << "LocalBundleAdjustment 12" << endl;
    for(unsigned int i=0; i < vpMPs.size(); ++i)
    {
        MapPoint* pMPi = vpMPs[i];
        if(pMPi->isBad())
    ...
    //Keyframes
    cout << "LocalBundleAdjustment 13" << endl;
    for(KeyFrame* pKFi : vpAdjustKF)
    {
        if(pKFi->isBad())
            continue;
    ...
    //cout << "End to update the KeyFrames" << endl;
    cout << "LocalBundleAdjustment 14" << endl;
    //Points
    for(MapPoint* pMPi : vpMPs)
    {
        if(pMPi->isBad())
	...
	cout << "LocalBundleAdjustment 14.1" << endl;
        g2o::VertexSBAPointXYZ* vPoint = static_cast<g2o::VertexSBAPointXYZ*>(optimizer.vertex(pMPi->mnId+maxKFid+1));
	cout << "LocalBundleAdjustment 14.2" << endl;
        pMPi->SetWorldPos(Converter::toCvMat(vPoint->estimate()));
	cout << "LocalBundleAdjustment 14.3" << endl;
        pMPi->UpdateNormalAndDepth();
	cout << "LocalBundleAdjustment 14.4" << endl;

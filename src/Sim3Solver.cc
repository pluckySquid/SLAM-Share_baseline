...
{
    std::cout << "Sim3Solver::Sim3Solver start" << std::endl;
    ...
    std::cout << "Sim3Solver::Sim3Solver 01" << std::endl;
    ...
    //std::cout << "Sim3Solver::Sim3Solver 02" << std::endl;
    FromCameraToImage(mvX3Dc1,mvP1im1,pCamera1);
    std::cout << "Sim3Solver::Sim3Solver 03" << std::endl;
    if(pCamera2 == NULL){
	std::cout << "Sim3Solver::Sim3Solver 03.5 pCamera2 is NULL" << std::endl;
    }else{
	std::cout << "Sim3Solver::Sim3Solver 03.5 pCamera2 is NOT NULL" << std::endl;
	if(pCamera2->GetType() == 0){
    ...
    std::cout << "Sim3Solver::Sim3Solver 04" << std::endl;
    SetRansacParameters();
    std::cout << "Sim3Solver::Sim3Solver end" << std::endl;
}
...
{
    //std::cout << "Sim3Solver::FromCameraToImage start" << std::endl;
    vP2D.clear();
    vP2D.reserve(vP3Dc.size());

    //std::cout << "Sim3Solver::FromCameraToImage 01, size: " << vP3Dc.size() << std::endl;
	...
	std::cout << "Sim3Solver::FromCameraToImage 02 pCamera is NULL? " << std::endl;//is NULL! << (pCamera == NULL) << std::endl;

        vP2D.push_back(pCamera->projectMat(cv::Point3f(x,y,z)));
	std::cout << "Sim3Solver::FromCameraToImage 03" << std::endl;
    }
    //std::cout << "Sim3Solver::FromCameraToImage end" << std::endl;
}

...
or sudo ./Examples/Monocular/mono_euroc_load_2_100images ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml '/home/adhak001/slam'/mh04 ./Examples/Monocular/EuRoC_TimeStamps/MH04.txt '/home/adhak001/slam'/mh05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt dataset-MH0405_1208

or sudo ./Examples/Monocular/mono_euroc_load_2_100images ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml '/home/adhak001/slam'/mh05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt dataset-MH0405_1208
...
./Examples/Monocular/mono_euroc_load_2-load1Do2 ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt dataset-MH_testMerge_1129 results/smallmap/multiple6kf/smallmap0.osa
	...
	python2 evaluation/evaluate_ate_scale_color_MarkAll.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_smallmap9.osa.txt --plot kf_1208.pdf




{   echo smallmapResult_009_000;    echo smallmapResult_009_000;  } | ./Examples/Monocular/mono_euroc_load_2-load1Do2 ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt dataset-MH_testMerge_1129 smallmap9.osa 1774 


./Examples/Monocular/mono_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt "$pathDatasetEuroc"/MH04 ./Examples/Monocular/EuRoC_TimeStamps/MH04.txt "$pathDatasetEuroc"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt space 8




 ./Examples/Monocular/mono_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt  "$pathDatasetEuroc"/MH04 ./Examples/Mo$
python2 evaluation/evaluate_ate_scale_color_MarkAll.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_getSmallMap12_0.txt --plot getSmallMap12_0.pdf

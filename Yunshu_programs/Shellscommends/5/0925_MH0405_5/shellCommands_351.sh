...
python2 evaluation/evaluate_ate_scale_color_final_saveResults.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-0925_351.txt --plot kf_dateset-MH0405-5_351.pdf 351 Yunshu_Results/0925/deletedResults2/missingFramesFile.txt
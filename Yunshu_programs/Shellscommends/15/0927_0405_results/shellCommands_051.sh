...
python2 evaluation/evaluate_ate_scale_color_final_saveResults.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-0927_51.txt --plot kf_dateset-MH0405-15_51.pdf 51 Yunshu_Results/0927/deletedResults2/missingFramesFile.txt
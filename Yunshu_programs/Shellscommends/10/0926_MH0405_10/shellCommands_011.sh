...
python2 evaluation/evaluate_ate_scale_color_final_saveResults.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-0926_11.txt --plot kf_dateset-MH0405-10_11.pdf 11 Yunshu_Results/0926/deletedResults2/missingFramesFile.txt
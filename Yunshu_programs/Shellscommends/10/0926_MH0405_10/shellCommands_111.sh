...
python2 evaluation/evaluate_ate_scale_color_final_saveResults.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-0926_111.txt --plot kf_dateset-MH0405-10_111.pdf 111 Yunshu_Results/0926/deletedResults2/missingFramesFile.txt
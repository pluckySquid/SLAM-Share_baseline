...
python2 evaluation/evaluate_ate_scale_color_final_saveResults.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-0923_2.txt --plot kf_dateset-MH0405-100_2.pdf 2 Yunshu_Results/0923/deletedResults2/missingFramesFile.txt
...
if __name__=="__main__":
    ...
    for i in range(0,22):
        ...
        A = "echo " + resultSava_fileName.split(".sh")[0] + " | ./Examples/Monocular/mono_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml \"$pathDatasetEuroc\"/MH05 ./Yunshu_Results/" + date +"/deletedResults2/MH05_" +str(i) + "_" +interval+".txt dataset-MH05-"+date+"_"+str(i) + "\n"
        B = "python2 evaluation/evaluate_ate_scale_color_final_markBoth_Online.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH05-"+date+"_" + str(i) +".txt --plot kf_dateset-MH05-"+interval+"_" + str(i) +".pdf "+ str(-1) +" Yunshu_Results/"+date+"/deletedResults2/missingFramesFile_MH04.txt "+ str(i)+" Yunshu_Results/" + date+"/deletedResults2/missingFramesFile_MH05.txt"

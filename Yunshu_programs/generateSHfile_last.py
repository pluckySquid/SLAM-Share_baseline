 ...
 #delay
    ...
    for j in range(12, 13):
        ...
        for i in range(0, 100 ):
            ...
            T = "{   echo " + resultSava_fileName.split(".sh")[0] + ";    echo " + resultSava_fileName.split(".sh")[0] + ";  } | ./Examples/Monocular/mono_euroc_load_2 ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml \"$pathDatasetEuroc\"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt  \"$pathDatasetEuroc\"/MH04 ./Examples/Monocular/EuRoC_TimeStamps/MH04.txt \"$pathDatasetEuroc\"/MH05 ./Examples/Monocular/EuRoC_TimeStamps/MH05.txt " + str(13) + " space " + str(2100)+ " \n"
            # s = 0
            # for t in range (0,13):

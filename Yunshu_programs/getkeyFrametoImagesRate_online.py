...
if __name__=="__main__":
    ...
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1030_MH04_0-2000/result/'
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1024_MH04_0-1000_MH05_1000-2200/result/'
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1020_MH04_1000-2000_MH05_0-1000/result_accurate/'
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1020_MH04_1000-2000_MH05_none/results/'
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1020_MH04_1000-2000_MH05_1000-2200/RESULTS/'
    path = '/home/ucrnet/Desktop/workspace/ORBSLAM3/Yunshu_Results/1030_MH04_0-2000_MH05_0-2200/result2/'
    ...
    fileWrite = open(path+"keyFrameResults_ONLINE_" + str(interval) +".txt", "w")
        ...
        if "f_dataset-MH" in str(file) and ".pdf" not in str(file) :
            ...
            if "kf_dataset-MH" not in str(file):
               ...
               # interval = int(str(file).split("online_")[1].split("_")[0])
                ...
                print(kf_length)
                fileWrite.write("keyframeRate of " + str(file) + " is: " + str(kf_length*1.0/count/interval) + "\n\n")

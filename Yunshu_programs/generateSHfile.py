...
if __name__=="__main__":
    ...
    for i in range(2000/int(interval)):
        ...
        B = "python2 evaluation/evaluate_ate_scale_color_final.py evaluation/Ground_truth/EuRoC_left_cam/merged_GT_samples.txt kf_dataset-MH0405-"+date+"_" + str(i) +".txt --plot kf_dateset-MH0405-"+interval+"_" + str(i) +".pdf "+ str(i) +" Yunshu_Results/"+date+"/deletedResults2/missingFramesFile.txt"
